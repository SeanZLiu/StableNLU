...
CUDA_VISIBLE_DEVICES=0 python get_shallow_output_full_tasks.py \
 ...
 --seed 111 --which_bias fever_claim_only_balanced --task fever \
   --get_bert_output --shallow_feature_file shallow_features/shallow_fever_train.pkl
done
...
CUDA_VISIBLE_DEVICES=0 python get_shallow_output_full_tasks.py \
 --output_dir ../experiments_shallow_fever/bert_base_sampled500_seed$file_name \
  --do_eval  --mode none\
 --seed 111 --which_bias fever_claim_only_balanced --task fever \
 --get_bert_output --shallow_feature_file shallow_features/shallow_fever_dev.pkl
done
...
CUDA_VISIBLE_DEVICES=0 python get_final_features.py \
 --output_dir ../experiments_self_debias_fever_seed222/bert_product_sampled500_teacher_seed333_annealed_fever \
  --do_eval --do_eval_on_train --mode none\
 --seed 111 --which_bias fever_claim_only_balanced --task fever \
   --get_bert_output --shallow_feature_file shallow_features/shallow_fever_train.pkl \
    --final_feature final_features/fever_train_features.pkl
...
CUDA_VISIBLE_DEVICES=0 python get_final_features.py \
 ...
 --seed 111 --which_bias fever_claim_only_balanced --task fever \
 --get_bert_output --shallow_feature_file shallow_features/shallow_fever_dev.pkl \
 --final_feature final_features/fever_dev_features.pkl
...
CUDA_VISIBLE_DEVICES=0 python get_final_features.py \
 ...
 --seed 111 --which_bias fever_claim_only_balanced --task fever \
 --get_bert_output --shallow_feature_file shallow_features/shallow_symm.pkl \
 --final_feature final_features/symm_features.pkl
